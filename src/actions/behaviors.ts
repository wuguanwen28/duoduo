/**
 * 行为库访问层 —— 从外置资源仓库（`../store/resources`）读取解析后的行为。
 *
 ...
 * 动作名在当前行为里播一次。
 */
import { getModel, type Behavior, type TwitchItem, type BehaviorLoop } from "../store/resources";
...
export { getDefaultBehavior } from "../store/resources";
